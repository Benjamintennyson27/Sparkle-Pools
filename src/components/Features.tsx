      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="feature-card flex flex-col gap-6">
            <h3 className="text-2xl font-bold text-navy">Servicing</h3>
            <p className="text-charcoal/70">On-site installation and repair. Our technicians are up to date with all types of pool equipment.</p>
            <ShufflerCard />
          </div>

          <div className="feature-card flex flex-col gap-6">
            <h3 className="text-2xl font-bold text-navy">Testing</h3>
            <p className="text-charcoal/70">Keep your pool healthy by testing it regularly. We recommend checking fortnightly in summer.</p>
            <TypewriterCard />
          </div>

          <div className="feature-card flex flex-col gap-6">
            <h3 className="text-2xl font-bold text-navy">Pool Supplies</h3>
            <p className="text-charcoal/70">Vast array of spare parts, accessories, and quality new pool equipment.</p>
            <SchedulerCard />
          </div>
        </div>
      </div>
