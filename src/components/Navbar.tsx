...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
      ...
      >
        <a href="#" className="flex items-center -ml-2" aria-label="Sparkle Pools & Spas">
          <img
            ...
            className="h-10 md:h-12 w-auto object-contain transition-all duration-300 transform origin-left hover:scale-105"
          />
        </a>
        ...
        <div className="flex items-center gap-4">
          <a href="tel:0295483133" className="hidden md:flex items-center gap-2 text-sm font-bold hover:text-aqua transition-colors" aria-label="Call us directly at (02) 9548 3133">
