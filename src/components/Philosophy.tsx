...
export default function Philosophy() {
  ...
  return (
    <section
      id="story"
      ref={container}
      aria-label="Our philosophy — we treat your pool like our own"
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto flex flex-col gap-12 md:gap-20">
        <div ref={text1Ref} className="text-xl md:text-3xl font-sans font-medium text-cream/60 max-w-2xl">
          Sparkle pools has been in the shire based at Engadine as an independent swimming pool service and maintenance company.
        </div>

        <div ref={text2Ref} className="text-4xl md:text-6xl lg:text-7xl font-serif italic text-white leading-tight">
          Setting the standard of pool care in the local area <span className="text-aqua not-italic font-sans font-bold">since 1985.</span>
        </div>
      </div>
    </section>
  );
