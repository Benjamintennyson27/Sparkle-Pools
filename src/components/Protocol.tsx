...
const protocols = [
  {
    ...
    desc: 'Keep your pool healthy by testing it regularly. We recommend testing your water fortnightly in the warmer months and monthly in winter.',
    Animation: () => (
  ...
  },
  {
    id: '02',
    title: 'Pool Supplies',
    desc: 'Looking for something new? We stock all of your pool needs at our Engadine store—from skimmer baskets to pump lids.',
    Animation: () => (
      <svg className="w-full h-full text-aqua" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  },
  {
    ...
    desc: 'Our technicians are up to date with all types of pool equipment, providing on-site installation, repair, and regular maintenance.',
    Animation: () => (
      <svg className="w-full h-full text-aqua" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2">
...
export default function Protocol() {
  ...
  return (
    <section aria-label="Maintaining your pool can be simple" className="protocol-container relative bg-cream" ref={containerRef}>
